...
namespace Fighting.Worker
{
    ...
    {
        private static readonly ILog Log = LogProvider.GetLogger(typeof(WorkerExtensions));
        ...
        /// </summary>
        public static void QueueTask(this IWorkerContext jobContext, IWorkerTaskContext taskContext)
        {
            if (jobContext.Queue == null)
                jobContext.Queue = new WorkerTaskContext[] { };
        ...
        /// </summary>
        public static void AddEnvironment(this IWorkerContext jobContext, string key, object value)
        {
        ...
        public static T GetEnvironment<T>(this IWorkerContext jobContext, string key)
        {
            if (jobContext.Environment == null)
        ...
        /// </summary>
        public static void AddResult(this IWorkerContext jobContext, string key, object value)
        {
        ...
        public static T GetResult<T>(this IWorkerContext jobContext, string key)
        {
            if (jobContext.Result == null)
        ...
        /// Add a result object to a job context
        /// </summary>
        public static void AddCompletedTask(this IWorkerContext jobContext, IWorkerTaskContext taskContext)
        {
            if (jobContext.Completed == null)
                jobContext.Completed = new WorkerTaskContext[] { };
        ...
        /// Set a task argument
        /// </summary>
        public static void AddArg(this IWorkerTaskContext taskContext, string key, object value)
        {
        ...
        /// </summary>
        /// <typeparam name="T">Argument value type</typeparam>
        public static T GetArg<T>(this IWorkerTaskContext taskContext, string key)
        {
            if (taskContext.Args == null)
