...
namespace Baibaocp.LotteryDispatcher.ShanghaiAwarding.Handlers
{
    ...
    public class OrderingCommandHandler : IExecuteHandler<AwardingExecuter>
    {
        ...
        {
            var handlerAttribute = typeof(OrderingCommandHandler).GetCustomAttributes<HandlerAttribute>();
